...
Останнє оновлення: інструменти 3+, написи та іконки ×2.25 (зменшено на чверть), торт перезапускає таймер.
...
| `BOARD_W/H` | **896** (7×128) |
| `GAME_W` | 960 |
| `GAME_H` | ~1671 (BOARD_OFFSET_Y 520 + поле 896 + хелпери 255) |
| HUD | білий блок зверху 500px, іконки лічильників **108px** (сітка 2×2), шрифти 50–80px |
...
│          ⏱ 01:24      (64px)           │
│   🌾 10/10✓   🥛 3/3✓                  │
│   🧈 5/5     🍓 5/5   (іконки 108px)  │
│   (сітка 2×2, ✓ при досягненні квоти)  │
├────────────────────────────────────────┤
│          поле 896×896                  │
│      (рамка, без bg.jpg)               │
├────────────────────────────────────────┤
...
HUD — білий блок зверху (висота 500px), лічильники інгредієнтів оновлюються з матчів FLOUR/MILK/BUTTER/ягід. Квоти беруться з `levels.json → ingredient_goals` (за замовчуванням: flour 10, milk 3, butter 5, berries 5). Лічичник, що досягнув квоти, зеленіє з `✓`.
